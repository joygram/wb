...
*/
	...
	include("$_skindir/imgbox/list_header.html") ;
	...
	for ($i =0; $i < $num_image ; $i ++) 
	{
		...
		include("$_skindir/imgbox/imgbox_list.html") ;

	}
	//$img_box .= "</table>";
	include("$_skindir/imgbox/list_footer.html") ;
	$imgbox_list = ob_get_contents() ;
	ob_end_clean() ;

	ob_start() ;
	include("$_skindir/imgbox/imgbox.html") ;
